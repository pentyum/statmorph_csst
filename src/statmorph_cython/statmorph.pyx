...
cdef class BigImageMorphology(StampMorphology):
	...
	cpdef void calculate_morphology(self, bint calc_cas, bint calc_g_m20, bint calc_shape_asymmetry, bint calc_mid,
		...
		print(calc_cas)
		print(calc_g_m20)
		print(calc_shape_asymmetry)
		print(calc_mid)
		print(calc_multiplicity)
		print(calc_color_dispersion)
		print(calc_g2)
		print(set_asym_center)
		BigImageMorphology.calculate_morphology(self, calc_cas, calc_g_m20, calc_shape_asymmetry, calc_mid, calc_multiplicity,calc_color_dispersion, calc_g2,set_asym_center)
